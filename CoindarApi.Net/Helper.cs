...
namespace Odry.CoindarAPI
{
    ...
    {
        internal const string ApiUrlHttpsBase = "https://coindar.org/api/v1/";
        ...
        {
            return DateTime.SpecifyKind(DateTime.ParseExact(dateTime, "yyyy-MM-dd HH:mm", InvariantCulture), DateTimeKind.Utc).ToLocalTime();
        }
